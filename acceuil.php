...
<body>
    ...
    <div class="mini_cart">
        <div class="cart_gallery">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="#"><img src="assets/front/img/product/product1.jpg" alt=""></a>
                </div>
                <div class="cart_info">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="#"><img src="assets/front/img/product/product2.jpg" alt=""></a>
                </div>
                <div class="cart_info">
                    ...
                    <div class="col-12">
                        <div class="header_container d-flex justify-content-between align-items-center">
                            ...
                            <div class="header_logo">
                                <a class="sticky_none" href="index.html"><img src="assets/front/img/logo/logo.png" alt=""></a>
                            </div>
                            <!--main menu start-->
    ...
    <section class="slider_section mb-63">
        <div class="slider_area slick_slider_activation" data-slick='{
            ...
            <div class="single_slider d-flex align-items-center" data-bgimg="assets/front/img/slider/slider1.jpg">
                <div class="container">
                    <div class="row">
        ...
        <div class="container">
            ...
            <div class="banner_container d-flex">
                <figure class="single_banner position-relative mr-30">
                    <img src="assets/front/img/bg/bg1.jpg" alt="">
                ...
                <figure class="single_banner position-relative">
                    <img src="assets/front/img/bg/bg2.jpg" alt="">
                    <figcaption class="banner_text position-absolute">
                        ...
                        <div class="product_slick slick_slider_activation" data-slick='{
                                ...
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="assets/front/img/product/product1.jpg"
                                                alt="consectetur">
                                        </a>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="assets/front/img/product/product2.jpg"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="assets/front/img/product/product3.jpg"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
                            ...
                            <article class="col single_product">
                                <figure>
                                    <div class="product_thumb">
                                        <a href="product-details.html">
                                            <img class="primary_img" src="assets/front/img/product/product4.jpg"
                                                alt="consectetur">
                                        </a>
                                        <div class="product_action">
                                            <ul>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <figure class="single_banner position-relative">
                        <img src="assets/front/img/bg/bg3.jpg" alt="">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <figure class="single_banner position-relative">
                        <img src="assets/front/img/bg/bg4.jpg" alt="">
            ...
            <div class="blog_container row">
                <div class="blog_slick slick_slider_activation" data-slick='{
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="assets/front/img/blog/blog1.jpg" alt=""></a>
                            </div>
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="assets/front/img/blog/blog2.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <div class="blog_meta">
                                    <ul class="d-flex">
                    ...
                    <article class="col single_blog">
                        <figure>
                            <div class="blog_thumb">
                                <a href="blog-details.html"><img src="assets/front/img/blog/blog3.jpg" alt=""></a>
                            </div>
                            <figcaption class="blog_content">
                                <div class="blog_meta">
                                    <ul class="d-flex">
                ...
                <div class="col-lg-5 col-md-5 col-sm-5">
                    <div class="footer_widget_list">
                        <div class="footer_logo">
                            <a href="#"><img src="assets/front/img/logo/logo.png" alt=""></a>
                        </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="modal_zoom_gallery">
                                    <div class="product_zoom_thumb">
                                        <img src="assets/front/img/product/big-product/product1.png" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
...
============================================ -->
    ...
    <script src="assets/front/js/vendor/popper.js"></script>
    <script src="assets/front/js/vendor/jquery-3.4.1.min.js"></script>
    ...
    <script src="assets/front/js/images-loaded.min.js"></script>
    <script src="assets/front/js/isotope.pkgd.min.js"></script>
    <script src="assets/front/js/jquery.nice-select.js"></script>
    <script src="assets/front/js/tippy-bundle.umd.js"></script>
    <script src="assets/front/js/jquery-ui.min.js"></script>
    <script src="assets/front/js/jquery.instagramFeed.min.js"></script>
    <script src="assets/front/js/jquery.magnific-popup.min.js"></script>
    <script src="assets/front/js/mailchimp-ajax.js"></script>
