...
<html lang="en">
    <head>
		...
		<!-- DataTables -->
		<link rel="stylesheet" href="assets/back/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
		<link rel="stylesheet" href="assets/back/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
		<link rel="stylesheet" href="assets/back/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
		<!-- Theme style -->
					...
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					  ...
					  <li class="nav-item menu-open">
						...
						<ul class="nav nav-treeview">
						  <li class="nav-item">
							<a href="index.php?action=produit" class="nav-link active">
					  ...
					  <li class="nav-item">
						<a href="index.php?action=homepage" class="nav-link">
